        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                <div class="max-w-2xl fade-in-up">
                    ...
                    <h1 class="text-5xl lg:text-7xl font-display font-bold text-gray-900 leading-tight mb-6">
                        Manage Bikes <br>
                ...
                <div class="relative lg:h-[600px] flex items-center justify-center fade-in-up delay-200">
                    ...
                    <img src="{{ asset('images/hero-bike.png') }}" alt="Smart Bike" class="relative z-10 w-full max-w-lg transform hover:scale-105 transition-transform duration-500 drop-shadow-2xl">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm text-gray-400">
                        <li><a href="#" class="hover:text-brand-500 transition-colors">About</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm text-gray-400">
                        ...
                        <li><a href="#" class="hover:text-brand-500 transition-colors">Terms</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <div class="flex gap-6">
                    <a href="#" class="text-gray-500 hover:text-white transition-colors"><i class="fa-brands fa-twitter"></i></a>
