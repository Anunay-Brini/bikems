...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white overflow-hidden shadow-sm rounded-xl border border-gray-100">
        <div class="p-8">
            <h1 class="text-2xl font-bold text-gray-900 font-display mb-6">Add New Bike</h1>
            ...
            <form method="POST" action="{{ route('bikes.store') }}" enctype="multipart/form-data" class="space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <div id="image-upload-wrapper" onclick="document.getElementById('file-upload').click()" 
                         class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-brand-400 transition-colors cursor-pointer bg-gray-50 hover:bg-white group overflow-hidden">
                        ...
                        <img id="image-preview" src="#" alt="Preview" class="hidden max-h-48 rounded-lg shadow-sm">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" required class="w-full rounded-lg border-gray-300 shadow-sm focus:border-brand-500 focus:ring-brand-500 transition-shadow" placeholder="e.g. Royal Enfield Continental GT 650">
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative rounded-md shadow-sm">
                            ...
                            <input type="number" name="price_per_day" id="price_per_day" required class="w-full rounded-lg border-gray-300 pl-7 shadow-sm focus:border-brand-500 focus:ring-brand-500 transition-shadow" placeholder="0.00">
                        </div>
                    </div>
                </div>
